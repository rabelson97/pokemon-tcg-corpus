...
EXPLICIT_SET_MAPPINGS: dict[str, Any] = {
    ...
    "2015xy": ("other", "mcdonalds-collection-2015"),
    "2016xy": ("other", "mcdonalds-collection-2016"),
    "2017sm": ("other", "mcdonalds-collection-2017"),
    "2018sm": ("other", "mcdonalds-collection-2018"),
    "2019sm": ("other", "mcdonalds-collection-2019"),
    "2021swsh": ("other", "mcdonalds-collection-2021"),
